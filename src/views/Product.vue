<template>
  ...
  <div v-for="product in getLatestProducts.data" :key="product.id" class="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
    ...
    <img class="object-cover ml-5" src="../assets/img/pr1.jpg" alt="product image" />
  ...
  <div class="mt-4 px-5 pb-5">
    <a href="#">
      <h5 v-if="(product.name).length < 24" class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{{ product.name }}</h5>
