      ...
      <div class="bg-white shadow">
        <div class="px-4 py-6 sm:px-8 sm:py-10">
          ...
          <div class="mt-6 flex items-center justify-between">
            ...
            <p class="text-2xl font-semibold text-gray-900"><span class="text-xs font-normal text-gray-400">Rp.&ensp;</span>{{
                totaHarga.toLocaleString({
                  style: 'currency',
                })
              }}</p>
          </div>
          ...
          <div class="mt-6 text-center">
            <button @click="cek" type="button" class="group inline-flex w-full items-center justify-center rounded-md bg-sky-600 px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-lime-400">
              Checkout
